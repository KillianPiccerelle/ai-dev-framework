...
> `install.sh` installs all 13 agents into `~/.claude/agents/` and all skills into `~/.claude/skills/` globally. `init-project.sh` detects existing Claude configuration and runs in update mode — nothing is overwritten.
